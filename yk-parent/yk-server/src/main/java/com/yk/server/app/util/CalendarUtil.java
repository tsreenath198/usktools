...
public final class CalendarUtil {
	...
	/**
	 * Checks whether the given day, month and year combination is a valid date or
	 * not.
	 * 
	 * @param year
	...
	/**
	 * Checks whether the given hour, minute and second combination is a valid time
	 * or not.
	 * 
	 * @param hour
	...
	/**
	 * Validate the actual date of the given date elements and returns a calendar
	 * instance based on the given date elements. The time is forced to 00:00:00.
	 * 
	 * @param year
	 *            The year part of the date.
	 * @param month
	...
	/**
	 * Validate the actual date of the given date elements and returns a calendar
	 * instance based on the given date elements.
	 * 
	 * @param year
	 *            The year part of the date.
	 * @param month
	 ...
	 * @param years
	 *            The amount of years to be added to the given calendar. Negative
	 ...
	 * @param months
	 *            The amount of months to be added to the given calendar. Negative
	 *            values are also allowed, it will just go back in time.
	 */
	...
	/**
	 * Add the given amount of days to the given calendar. The changes are reflected
	 ...
	 * @param hours
	 *            The amount of hours to be added to the given calendar. Negative
	 *            values are also allowed, it will just go back in time.
	 */
	 ...
	 * @param minutes
	 *            The amount of minutes to be added to the given calendar. Negative
	 *            values are also allowed, it will just go back in time.
	 */
	 ...
	 * @param seconds
	 *            The amount of seconds to be added to the given calendar. Negative
	 *            values are also allowed, it will just go back in time.
	 */
	 ...
	 * @param millis
	 *            The amount of millis to be added to the given calendar. Negative
	 *            values are also allowed, it will just go back in time.
	 */
	 ...
	 * @param two
	 *            The other calendar.
	 * @return True if the two given calendars are dated on the same year, month and
	 *         day.
	 */
	...
	/**
	 * Returns <tt>true</tt> if the two given calendars are dated on the same time.
	 * The difference from <tt>one.equals(two)</tt> is that this method does not
	 ...
	 * 
	 * @param before
	 *            The first calendar with expected date before the second calendar.
	 * @param after
	 *            The second calendar with expected date after the first calendar.
	...
	/**
	 * Calculate the total of elapsed time from years up to seconds between the two
	 * given calendars. It returns an int array with the elapsed years, months,
	 ...
	 * @param after
	 *            The second calendar with expected date after the first calendar.
	 * @return The elapsed time between the two given calendars in years, months,
	...
	/**
	 * Retrieve the amount of elapsed time between the two given calendars based on
	 * the given calendar field as definied in the Calendar constants, e.g.
	 ...
	 * @return The amount of elapsed time between the two given calendars based on
	...
	/**
	 * Retrieve the amount of elapsed milliseconds between the two given calendars
	 * and directly divide the outcome by the given factor. E.g.: if the division
	 * factor is 1, then you will get the elapsed milliseconds unchanged; if the
	 * division factor is 1000, then the elapsed milliseconds will be divided by
	 * 1000, resulting in the amount of elapsed seconds.
	 * 
	 * @param before
	 *            The first calendar with expected date before the second calendar.
	 * @param after
	 ...
	 * @throws IllegalArgumentException
	 *             If the first calendar is dated after the second calendar or if
	 *             the division factor is less than 1.
	 */
